...
namespace Nuke.Common.BuildServers
{
    ...
    public class GitHubActions
    {
        ...
        internal static bool IsRunningGitHubActions => Environment.GetEnvironmentVariable("GITHUB_WORKFLOW") != null;
        ...
        private void WriteCommand(
            ...
            string message = null)
        {
            var keyValues = dictionaryConfigurator?
        ...
        {
            Console.WriteLine($"::{escapedTokens.JoinSpace()}::");
        }
